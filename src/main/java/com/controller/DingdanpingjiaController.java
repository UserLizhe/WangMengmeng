...
public class DingdanpingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,DingdanpingjiaEntity dingdanpingjia,
		...
		if(tableName.equals("shangjia")) {
			dingdanpingjia.setShangjiabianhao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("qishou")) {
			dingdanpingjia.setQishougonghao((String)request.getSession().getAttribute("username"));
		}
