...
public class QishouController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		QishouEntity user = qishouService.selectOne(new EntityWrapper<QishouEntity>().eq("qishougonghao", username));
    ...
    public R register(@RequestBody QishouEntity qishou){
    	...
    	QishouEntity user = qishouService.selectOne(new EntityWrapper<QishouEntity>().eq("qishougonghao", qishou.getQishougonghao()));
		if(user!=null) {
