...
public class DingdanxinxiEntity<T> implements Serializable {
	...
	private String caipinjiage;
	
	/**
	 * 点餐数量
	 */
					
	private Integer diancanshuliang;
	 ...
	 * 设置：菜品价格
	 */
	public void setCaipinjiage(String caipinjiage) {
		this.caipinjiage = caipinjiage;
	}
	/**
	 * 获取：菜品价格
	 */
	public String getCaipinjiage() {
		return caipinjiage;
	}
	/**
	 * 设置：点餐数量
	 */
	public void setDiancanshuliang(Integer diancanshuliang) {
		this.diancanshuliang = diancanshuliang;
	}
	/**
	 * 获取：点餐数量
	 */
	public Integer getDiancanshuliang() {
		return diancanshuliang;
	}
	/**
	 * 设置：订单总额
	 */
