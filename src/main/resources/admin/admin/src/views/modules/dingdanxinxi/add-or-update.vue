<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="点餐数量" prop="diancanshuliang">
          <el-input v-model="ruleForm.diancanshuliang" 
              placeholder="点餐数量" clearable  :readonly="ro.diancanshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="点餐数量" prop="diancanshuliang">
              <el-input v-model="ruleForm.diancanshuliang" 
                placeholder="点餐数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="订单总额" prop="dingdanzonge">
            <el-input v-model="dingdanzonge"
                placeholder="订单总额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dingdanzonge" label="订单总额" prop="dingdanzonge">
              <el-input v-model="ruleForm.dingdanzonge" 
                placeholder="订单总额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="配送方式" prop="peisongfangshi">
          <el-select :disabled="ro.peisongfangshi" v-model="ruleForm.peisongfangshi" placeholder="请选择配送方式">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="配送方式" prop="peisongfangshi">
	      <el-input v-model="ruleForm.peisongfangshi"
                placeholder="配送方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="下单备注" prop="xiadanbeizhu">
          <el-input v-model="ruleForm.xiadanbeizhu" 
              placeholder="下单备注" clearable  :readonly="ro.xiadanbeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="下单备注" prop="xiadanbeizhu">
              <el-input v-model="ruleForm.xiadanbeizhu" 
                placeholder="下单备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	ispay : false,
      ...
      rules: {
          ...
          diancanshuliang: [
                { required: true, message: '点餐数量不能为空', trigger: 'blur' },
  ...
  computed: {
    dingdanzonge:{
      get: function () {
        return 1*this.ruleForm.caipinjiage*this.ruleForm.diancanshuliang
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.caipinjiage = true;
          ...
          if(o=='diancanshuliang'){
            this.ruleForm.diancanshuliang = obj[o];
	    this.ro.diancanshuliang = true;
            continue;
          }
          if(o=='dingdanzonge'){
            this.ruleForm.dingdanzonge = obj[o];
	    this.ro.dingdanzonge = true;
            continue;
          }
	    ...
	    this.ro.xiadanshijian = true;
          ...
          if(o=='peisongfangshi'){
            this.ruleForm.peisongfangshi = obj[o];
	    this.ro.peisongfangshi = true;
            continue;
          }
          if(o=='xiadanbeizhu'){
    ...
    // 提交
    onSubmit() {
        this.ruleForm.dingdanzonge = this.dingdanzonge
