<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="骑手工号" prop="qishougonghao">
          <el-input v-model="ruleForm.qishougonghao" 
              placeholder="骑手工号" clearable  :readonly="ro.qishougonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="骑手工号" prop="qishougonghao">
              <el-input v-model="ruleForm.qishougonghao" 
                placeholder="骑手工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="菜品评分" prop="caipinpingfen">
          <el-select :disabled="ro.caipinpingfen" v-model="ruleForm.caipinpingfen" placeholder="请选择菜品评分">
            <el-option
                v-for="(item,index) in caipinpingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="菜品评分" prop="caipinpingfen">
	      <el-input v-model="ruleForm.caipinpingfen"
                placeholder="菜品评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商家评分" prop="shangjiapingfen">
          <el-select :disabled="ro.shangjiapingfen" v-model="ruleForm.shangjiapingfen" placeholder="请选择商家评分">
            <el-option
                v-for="(item,index) in shangjiapingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="商家评分" prop="shangjiapingfen">
	      <el-input v-model="ruleForm.shangjiapingfen"
                placeholder="商家评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="骑手评分" prop="qishoupingfen">
          <el-select :disabled="ro.qishoupingfen" v-model="ruleForm.qishoupingfen" placeholder="请选择骑手评分">
            <el-option
                v-for="(item,index) in qishoupingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="骑手评分" prop="qishoupingfen">
	      <el-input v-model="ruleForm.qishoupingfen"
                placeholder="骑手评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="订单评价" prop="dingdanpingjia">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.dingdanpingjia" label="订单评价" prop="dingdanpingjia">
                    <span v-html="ruleForm.dingdanpingjia"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
	...
	shhf : false,
      ...
      ruleForm: {
        ...
        shhf: '',
          ...
          caipinpingfenOptions: [],
          shangjiapingfenOptions: [],
          qishoupingfenOptions: [],
      ...
      rules: {
          ...
          caipinpingfen: [
                { required: true, message: '菜品评分不能为空', trigger: 'blur' },
          ],
          shangjiapingfen: [
                { required: true, message: '商家评分不能为空', trigger: 'blur' },
          ],
          qishoupingfen: [
                { required: true, message: '骑手评分不能为空', trigger: 'blur' },
          ],
          zonghepingfen: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangjiabianhao = true;
          ...
          if(o=='qishougonghao'){
            this.ruleForm.qishougonghao = obj[o];
	    this.ro.qishougonghao = true;
            continue;
          }
          if(o=='caipinpingfen'){
            this.ruleForm.caipinpingfen = obj[o];
	    this.ro.caipinpingfen = true;
            continue;
          }
          if(o=='shangjiapingfen'){
            this.ruleForm.shangjiapingfen = obj[o];
	    this.ro.shangjiapingfen = true;
            continue;
          }
          if(o=='qishoupingfen'){
            this.ruleForm.qishoupingfen = obj[o];
	    this.ro.qishoupingfen = true;
            continue;
          }
          if(o=='zonghepingfen'){
      ...
      this.$http({
		...
		if(this.$storage.get("role")!="管理员") {
          ...
          this.$message.error(data.msg);
            ...
            this.caipinpingfenOptions = "1,2,3,4,5".split(',')
            this.shangjiapingfenOptions = "1,2,3,4,5".split(',')
            this.qishoupingfenOptions = "1,2,3,4,5".split(',')
            this.zonghepingfenOptions = "1,2,3,4,5".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.dingdanpingjia = this.ruleForm.dingdanpingjia.replace(reg,'../../../springboot4co0k/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
