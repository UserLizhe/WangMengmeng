<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="骑手电话" prop="qishoudianhua">
          <el-input v-model="ruleForm.qishoudianhua" 
              placeholder="骑手电话" clearable  :readonly="ro.qishoudianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="骑手电话" prop="qishoudianhua">
              <el-input v-model="ruleForm.qishoudianhua" 
                placeholder="骑手电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qishouxingming = true;
          ...
          if(o=='qishoudianhua'){
            this.ruleForm.qishoudianhua = obj[o];
	    this.ro.qishoudianhua = true;
            continue;
          }
          if(o=='peisongshijian'){
      ...
      this.$http({
		...
		if(json.qishougonghao!=''&&json.qishougonghao){
              		this.ruleForm.qishougonghao = json.qishougonghao
	    		this.ro.qishougonghao = true;
		}
		if(this.$storage.get("role")!="管理员") {
			this.ro.qishougonghao = true;
		...
		if(json.qishoudianhua!=''&&json.qishoudianhua){
              		this.ruleForm.qishoudianhua = json.qishoudianhua
	    		this.ro.qishoudianhua = true;
		}
		if(this.$storage.get("role")!="管理员") {
			this.ro.qishoudianhua = true;
          ...
          this.$message.error(data.msg);
            ...
            this.peisongzhuangtaiOptions = "配送中,已送达".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
