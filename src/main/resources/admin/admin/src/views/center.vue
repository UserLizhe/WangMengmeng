  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='shangjia'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='qishou'"  label="骑手工号" prop="qishougonghao">
          <el-input v-model="ruleForm.qishougonghao" readonly              placeholder="骑手工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='qishou'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='qishou'"  label="骑手电话" prop="qishoudianhua">
          <el-input v-model="ruleForm.qishoudianhua"               placeholder="骑手电话" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.qishougonghao)&& 'qishou'==this.flag){
      ...
      if( 'qishou' ==this.flag && this.ruleForm.qishoudianhua&&(!isMobile(this.ruleForm.qishoudianhua))){
