  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(101, 126, 253, 1);fontSize:25px;">校园食堂外卖系统的设计与实现注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='qishou'" class="input-group">
			   <div class="label">骑手工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qishougonghao" class="input" type="text" placeholder="骑手工号">
			   </div>
			 </div> -->
			<el-form-item label="骑手工号" class="input" v-if="tableName=='qishou'">
			  <el-input v-model="ruleForm.qishougonghao" autocomplete="off" placeholder="骑手工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='qishou'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<!-- <div v-if="tableName=='qishou'" class="input-group">
			   <div class="label">骑手电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qishoudianhua" class="input" type="text" placeholder="骑手电话">
			   </div>
			 </div> -->
			<el-form-item label="骑手电话" class="input" v-if="tableName=='qishou'">
			  <el-input v-model="ruleForm.qishoudianhua" autocomplete="off" placeholder="骑手电话"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.qishougonghao) && `qishou` == this.tableName){
        this.$message.error(`骑手工号不能为空`);
        return
      }
